...
export const hoverBackground = accent
...
export const desc = "0.9rem"
export const shadow = "1px 1px 1px black"
export const border = "2px solid white;"
export const bpLarge = "1400px"
export const bpMedium = "1100px"
export const bpSmall = "700px"
export const fontFamilyPrimary = "sans-serif"